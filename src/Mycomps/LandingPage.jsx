...
export const LandingPage = (props) => {
  ...
  return (
    <div className="overflow-hidden">
      <div
        className="hidden bg-cover bg-center bg-no-repeat sm:flex sm:flex-col justify-start items-center"
          ...
          >
            <div className="text-white space-y-0 spaced flex justify-center flex-col">
              ...
              <a
                ...
                target="_blank"
                className="flex justify-center items-center w-[140px] h-[60px] uppercase text-2xl  spaced tracking-widest rounded-md border cursor-pointer hover:border-[#E72D2D] hover:text-[#E72D2D] transition-colors duration-300"
              >
                REGISTER
              </a>
          ...
          <div className="hidden sm:block w-screen h-screen">
            ...
            <div className="w-screen flex flex-col">
              ...
              <div className="flex flex-row items-start">
                <div
                  id="spaceShip"
                  className="ml-[14vw] flex flex-col justify-center items-center transition-all duration-1000 -translate-y-[30vh] rotate-180"
                >
                  <div className="text-white text-[10px] font-bold">
                    <span className="text-[#E72D2D]">CABIN MICS</span>:
                    RECORDING
                  </div>

                  <img
                    className="h-[40vh] aspect-auto"
                    src="Images/SpaceShipLandingPage.svg"
                    alt="SpaceShip"
                  />
                </div>
                ...
                <div className="flex flex-col ml-[5vw]">
                  ...
                  >
                    ...
                    Hacking Competitions, Battle of Bands, keynote sessions by
                    renowned speakers, etcetera; to be held in the month of
                    November. In the span of 3 days, Technovate is designed to
                    provide a powerful problem-solving environment to help build
                    new ideas as well as a stage to showcase one's cultural
                    prowess which range from stand-ups to renounced singers and
                    EDM. In the last edition, Technovate received 5000+
                    registrations and this time, with the scale and the time-gap
                    being much larger, we are expecting over 7000+
                    registrations. The main idea behind Technovate is to provide
                    students with a dynamic environment to showcase their skills
      ...
      <div className="sm:hidden">
        <div
          className="flex flex-col sm:hidden bg-cover bg-no-repeat h-full w-full"
          style={{ backgroundImage: "url(./Images/Background.jpg)" }}
        >
          <Navbar />
          <div className="flex flex-col sm:hidden text-white pt-16 sm:pt-0 w-full pl-2">
            <div className="flex flex-col spaced justify-start items-start space-y-3">
              ...
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="bg-transparent text-3xl border-white rounded-xl border px-3 py-4"
              >
                REGISTER
              </a>
            </div>
            ...
            <div className="mt-3 flex flex-col px-3">
              ...
              <div className="mt-2 bg-black bg-opacity-50 p-4">
                Technovate is the annual techno-cultural fest of IIIT-NR which
                includes but is not limited to Coding competitions, Hacking
                Competitions, Battle of Bands, keynote sessions by renowned
                speakers, etcetera; to be held in the month of November. In the
                span of 3 days, Technovate is designed to provide a powerful
                problem-solving environment to help build new ideas as well as a
                stage to showcase one's cultural prowess which range from
                stand-ups to renounced singers and EDM. In the last edition,
                Technovate received 5000+ registrations and this time, with the
                scale and the time-gap being much larger, we are expecting over
                7000+ registrations. The main idea behind Technovate is to
                provide students with a dynamic environment to showcase their
                skills in any field they desire.
              </div>

              <div>
                <div className="text-xl tracking-wide text-center spaced">
                  Technovate 2022 Teaser
                </div>
                <video
                  className="h-[240px] w-full px-2 mt-5"
                  controls
                  poster="./Images/Blog/logo.png"
                >
                  <source src="./Images/teaser.mp4" type="video/mp4" />
