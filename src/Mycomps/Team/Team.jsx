...
export const Team = () => {
  const team = [
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/lekhana-mysore-adiseshanaik-6b36b822a/",
  ...
  return (
    <div
      className="sm:pt-6 bg-cover bg-center text-white bg-no-repeat flex flex-col justify-start items-center"
    ...
    >
      ...
      <div className="pt-10 flex flex-col justify-center items-center">
        <div className="spaced uppercase text-4xl tracking-wider">Team</div>
