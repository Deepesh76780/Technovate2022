...
export const TeamCard = ({
  ...
  return (
    <div className="flex flex-col w-48 h-48 md:h-60 md:w-60 justify-center items-center relative">
      <div className="z-0">
        <img
          src={image}
          className={` rounded-2xl object-cover ${css}`}
          alt=""
        />
      </div>
      <div className="text-base tracking-widest mt-2">{name}</div>
